    ...
    <?php include 'inc/navbar.php'; ?>
      ...
      <div class="row wow fadeIn mt-5">
        ...
        <div class="col-md-6 mb-4 text-center">
            <?php  
            // sql query to get the right product
$query = "SELECT programs.program_id, programs.name, programs.sku, programs.price, programs.image, programs.desk, programs.catid from  programs WHERE programs.program_id = ?";
$stmt = $dbh->prepare($query);
$stmt->bindParam(1,$pid);
$stmt->execute();
$program = $stmt->fetch();
          ...
          <img src="<?php echo $program['image']; ?>" class="img-fluid" alt="">
          ...
          <div class="p-4">
            ...
            <p class="lead">
              <span class="mr-1 oldPrice">
                <del>$<?php echo round($program['price']*1.7 , 2); ?></del>
              </span>
              <span>$<?php echo $program['price']; ?></span>
            </p>

            <p class="lead font-weight-bold"><?php echo $program['name']; ?></p>

            <p><?php echo $program['desk']; ?></p>
            ...
            <!-- <form class="d-flex justify-content-left"> -->
              ...
              action="<?php echo $_SERVER['PHP_SELF'];?>?action=addcart&pid=<?php echo $pid ?>">
                             ...
                             <button class="btn btn-secondary btn-md my-0 p" type="submit">Add to cart
                                 ...
                                 <input type="hidden" name="sku" value="<?php print $program['sku']?>">
                             </p>
              </form>
